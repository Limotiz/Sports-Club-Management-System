function SportCard({ sport }) {
  return (
    <div className="group bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden hover:-translate-y-2 transition duration-300 hover:border-emerald-500">
